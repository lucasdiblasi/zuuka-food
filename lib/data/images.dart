...
const DUMMY_RESTAURANT = const [
  Restaurant(
    id: 'r1',
    categories: ['c3'],
    title: 'Best Burguer',
    imageUrl: 'https://cdna.artstation.com/p/assets/images/images/018/717/088/large/juan-victor-logo-burger.jpg?1560435358',
    description: 'Lanchonete, dogão prensado',
    tempEnt: 50,
    status: Status.Close,
  ),
  Restaurant(
    ...
    categories: ['c3'],
    title: 'Dogão',
    imageUrl: 'https://static-images.ifood.com.br/image/upload/f_auto,t_high/logosgde/5dadfa13-d180-45af-af4f-0cf690a196be/201902082239_imag.jpeg',
    description: 'Lanchonete, dogão prensado',
    tempEnt: 50,
    status: Status.Open,
  ),
...
const DUMMY_MEALS= const [
  Meal(
   id: 'm1',
   title: 'Mega Costela Burguer',
   restaurant: ['r1'],
   imageUrl: 'https://p2.trrsf.com/image/fget/cf/460/0/images.terra.com/2020/05/27/shutterstock1710468256.jpg',
   description: 'Hambúrguer artesanal de 250 gramas assado na brasa e recheado com queijo provolone, mais queijo provolone sobreposto ao hambúrguer e maionese artesanal. Pão fofinho selado na manteiga',
   quantity: 2,
   price: 14.50,
   complement: [
     'Ovo',
